...
GetProductInCartResponse _$GetProductInCartResponseFromJson(
    Map<String, dynamic> json) {
  return _GetProductInCartResponse.fromJson(json);
}

/// @nodoc
class _$GetProductInCartResponseTearOff {
  const _$GetProductInCartResponseTearOff();

  _GetProductInCartResponse call(
      {required int total,
      required List<ProductInCart> items,
      required String createdAt,
      required String updatedAt}) {
    return _GetProductInCartResponse(
      total: total,
      items: items,
      createdAt: createdAt,
      updatedAt: updatedAt,
  ...
  GetProductInCartResponse fromJson(Map<String, Object> json) {
    return GetProductInCartResponse.fromJson(json);
  }
}

/// @nodoc
const $GetProductInCartResponse = _$GetProductInCartResponseTearOff();

/// @nodoc
mixin _$GetProductInCartResponse {
  ...
  @JsonKey(ignore: true)
  $GetProductInCartResponseCopyWith<GetProductInCartResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetProductInCartResponseCopyWith<$Res> {
  factory $GetProductInCartResponseCopyWith(GetProductInCartResponse value,
          $Res Function(GetProductInCartResponse) then) =
      _$GetProductInCartResponseCopyWithImpl<$Res>;
  $Res call(
      {int total,
...
/// @nodoc
class _$GetProductInCartResponseCopyWithImpl<$Res>
    implements $GetProductInCartResponseCopyWith<$Res> {
  _$GetProductInCartResponseCopyWithImpl(this._value, this._then);

  final GetProductInCartResponse _value;
  // ignore: unused_field
  final $Res Function(GetProductInCartResponse) _then;
...
/// @nodoc
abstract class _$GetProductInCartResponseCopyWith<$Res>
    implements $GetProductInCartResponseCopyWith<$Res> {
  factory _$GetProductInCartResponseCopyWith(_GetProductInCartResponse value,
          $Res Function(_GetProductInCartResponse) then) =
      __$GetProductInCartResponseCopyWithImpl<$Res>;
  @override
  $Res call(
      {int total,
      List<ProductInCart> items,
...
/// @nodoc
class __$GetProductInCartResponseCopyWithImpl<$Res>
    extends _$GetProductInCartResponseCopyWithImpl<$Res>
    implements _$GetProductInCartResponseCopyWith<$Res> {
  __$GetProductInCartResponseCopyWithImpl(_GetProductInCartResponse _value,
      $Res Function(_GetProductInCartResponse) _then)
      : super(_value, (v) => _then(v as _GetProductInCartResponse));

  @override
  _GetProductInCartResponse get _value =>
      super._value as _GetProductInCartResponse;
  ...
  $Res call({
    ...
    return _then(_GetProductInCartResponse(
      total: total == freezed
          ? _value.total
          : total // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$_GetProductInCartResponse
    with DiagnosticableTreeMixin
    implements _GetProductInCartResponse {
  const _$_GetProductInCartResponse(
      {required this.total,
      required this.items,
      required this.createdAt,
      required this.updatedAt});

  factory _$_GetProductInCartResponse.fromJson(Map<String, dynamic> json) =>
      _$_$_GetProductInCartResponseFromJson(json);
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GetProductInCartResponse(total: $total, items: $items, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'GetProductInCartResponse'))
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _GetProductInCartResponse &&
  ...
  @JsonKey(ignore: true)
  @override
  _$GetProductInCartResponseCopyWith<_GetProductInCartResponse> get copyWith =>
      __$GetProductInCartResponseCopyWithImpl<_GetProductInCartResponse>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$_$_GetProductInCartResponseToJson(this);
  }
}

abstract class _GetProductInCartResponse implements GetProductInCartResponse {
  const factory _GetProductInCartResponse(
      {required int total,
      required List<ProductInCart> items,
      required String createdAt,
      required String updatedAt}) = _$_GetProductInCartResponse;

  factory _GetProductInCartResponse.fromJson(Map<String, dynamic> json) =
      _$_GetProductInCartResponse.fromJson;
